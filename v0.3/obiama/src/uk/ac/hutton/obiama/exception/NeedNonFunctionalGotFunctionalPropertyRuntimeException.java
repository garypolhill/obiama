...
/**
 * NeedNonFunctionalGotFunctionalPropertyRuntimeException
 * 
 * Provide a RuntimeException for the
 * NeedNonFunctionalGotFunctionalPropertyException class. This is required in
 * some methods that override language-standard methods and cannot declare that
 * they throw this exception.
 * 
 * @author Gary Polhill
 */
public class NeedNonFunctionalGotFunctionalPropertyRuntimeException extends
    RuntimeException {
  /**
   * Serial number
   */
   ...
   */
  NeedNonFunctionalGotFunctionalPropertyException e;
   ...
   */
  public NeedNonFunctionalGotFunctionalPropertyRuntimeException(Process process,
      URI property) {
    e = new NeedNonFunctionalGotFunctionalPropertyException(process, property);
  }
